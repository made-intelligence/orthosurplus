...
const QUICK_ACTIONS = [
  ...
  { icon: ic.bldg, label: 'My Sites', sub: '3 delivery locations', color: T.ink60, to: '/dashboard' },
]
    ...
    <div>
      ...
      <div className="grid-3" style={{
        ...
        {QUICK_ACTIONS.map((q, i) => (
          <Link key={q.label} href={q.to} style={{ textDecoration: 'none' }}>
            <Card hover style={{ padding: 18, animation: `fadeUp .5s ${i * 0.04}s both` }}>
      ...
      <h2 style={{ fontSize: 16, fontWeight: 700, fontFamily: T.fH, color: T.ink, margin: '0 0 12px' }}>
        Recent orders
      </h2>
      {RECENT_ORDERS.map((o) => (
        <Link key={o.num} href="/orders" style={{ textDecoration: 'none' }}>
          <Card hover style={{ padding: '16px 20px', marginBottom: 8 }}>
            <div style={{
